...
import { formatMessageTime } from "@/components/shared/formatMessageTime";
              ...
              conversationList.map((conv) => {
                ...
                return (
                  ...
                  >
                    ...
                    <p className="text-[10px] text-gray-400 mt-1">{formatDistanceToNow(new Date(lastMsg.created_date), { addSuffix: true })}</p>
                  </button>
                );
              })
            )}
                  ...
                  <div key={msg.id} className="flex gap-3">
                    ...
                    <div className="flex-1">
                      <div className="flex items-baseline gap-2 mb-1">
                        ...
                        <p className="text-xs text-gray-400">{new Date(msg.created_date).toLocaleString('en-US', { hour: 'numeric', minute: '2-digit', hour12: true })}</p>
                      </div>
